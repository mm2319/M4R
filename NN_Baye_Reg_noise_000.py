...
network_lorenz.load_weights('./NN_lorenz_checkpoints_000/my_checkpoint', save_format="tf")
T, Y = create_data_nonlinear(p=0.)
network_nonlinear.load_weights('./NN_nonlinear_checkpoints_000/my_checkpoint', save_format="tf")
T, Y = create_data_twocompart(p=0.)
network_twocompart.load_weights('./NN_twocompart_checkpoints_000/my_checkpoint', save_format="tf")
print("$"*25)
...
np.save('nn_BR_DSS_000_tc_1',start_1['z_1'])
np.save('nn_BR_DSS_000_tc_1_Z',start_1['pn_1'])
np.save('nn_BR_DSS_000_tc_2',start_2['z_1'])
np.save('nn_BR_DSS_000_tc_2_Z',start_2['pn_1'])
T, Y = create_data_nonlinear(p=0.)
...
np.save('nn_BR_DSS_000_nl_1',start_1['z_1'])
np.save('nn_BR_DSS_000_nl_1_Z',start_1['pn_1'])
np.save('nn_BR_DSS_000_nl_2',start_2['z_1'])
np.save('nn_BR_DSS_000_nl_2_Z',start_2['pn_1'])
T, Y = create_data_lorenz(p=0.)
...
np.save('nn_BR_DSS_000_lr_1',start_1['z_1'])
np.save('nn_BR_DSS_000_lr_1_Z',start_1['pn_1'])
np.save('nn_BR_DSS_000_lr_2',start_2['z_1'])
np.save('nn_BR_DSS_000_lr_2_Z',start_2['pn_1'])
np.save('nn_BR_DSS_000_lr_3',start_3['z_1'])
np.save('nn_BR_DSS_000_lr_3_Z',start_3['pn_1'])
...
print("the value of pn_1 in model_2 of lorenz model is",start_2['pn_1'])
np.save('nn_BR_MDSS_000_tc_1',start_1['z_1'])
np.save('nn_BR_MDSS_000_tc_1_Z',start_1['pn_1'])
np.save('nn_BR_MDSS_000_tc_2',start_2['z_1'])
np.save('nn_BR_MDSS_000_tc_2_Z',start_2['pn_1'])
...
print("the value of pn_1 in model_2 of lorenz model is",start_2['p_1'])
print("the value of pn_1 in model_2 of lorenz model is",start_2['pn_1'])
np.save('nn_BR_MDSS_000_nl_1',start_1['z_1'])
np.save('nn_BR_MDSS_000_nl_1_Z',start_1['pn_1'])
np.save('nn_BR_MDSS_000_nl_2',start_2['z_1'])
np.save('nn_BR_MDSS_000_nl_2_Z',start_2['pn_1'])
...
print("the value of pn_1 in model_3 of lorenz model is",start_3['pn_1'])
np.save('nn_BR_MDSS_000_lr_1',start_1['z_1'])
np.save('nn_BR_MDSS_000_lr_1_Z',start_1['pn_1'])
np.save('nn_BR_MDSS_000_lr_2',start_2['z_1'])
np.save('nn_BR_MDSS_000_lr_2_Z',start_2['pn_1'])
np.save('nn_BR_MDSS_000_lr_3',start_3['z_1'])
np.save('nn_BR_MDSS_000_lr_3_Z',start_3['pn_1'])