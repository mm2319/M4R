...
np.save('nn_BR_CSS_000_tc_1',start_1['beta_1'])
np.save('nn_BR_CSS_000_tc_2',start_2['beta_1'])


T, Y = create_data_nonlinear(p=0.)
model = FeedForwardNetwork(2)
x_1_train, y_1_train, y_2_train  = obtain_twocompart_data(network_nonlinear, T)
...
np.save('nn_BR_CSS_000_nl_1',start_1['beta_1'])
np.save('nn_BR_CSS_000_nl_2',start_2['beta_1'])

T, Y = create_data_lorenz(p=0.)
x_1_train, y_1_train, y_2_train, y_3_train  = obtain_twocompart_data(network_lorenz, T)
...
np.save('nn_BR_CSS_000_lr_1',start_1['beta_1'])
np.save('nn_BR_CSS_000_lr_2',start_2['beta_1'])
np.save('nn_BR_CSS_000_lr_3',start_3['beta_1'])
