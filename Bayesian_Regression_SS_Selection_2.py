...
def Bayesian_regression_SS_Selction(Y_1, X_1, size_fun_lib, further_prior=True):
    ...
    with basic_model:
        start = {}
        start['beta_1'] = trace_rh.posterior['beta_1'][1,-100:].mean(axis=0)
        start['mu_1'] = trace_rh.posterior['mu_1'][1,-100:].mean(axis=0)
        start['p_1'] = trace_rh.posterior['p_1'][1,-100:].mean(axis=0)
        start['pn_1'] = trace_rh.posterior['pn_1'][1,-100:].mean(axis=0)
        start['z_1'] = trace_rh.posterior['z_1'][1,-100:].mean(axis=0)
