...
network_lorenz.save_weights('./NN_lorenz_checkpoints_025/my_checkpoint', save_format="tf")
T, Y = create_data_nonlinear(p=0.25)
train_nonlinear(network_nonlinear, 8000,T=T,Y=Y)
network_nonlinear.save_weights('./NN_nonlinear_checkpoints_025/my_checkpoint', save_format="tf")
