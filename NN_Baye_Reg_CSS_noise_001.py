...
train_lorenz(network_lorenz, 8000,T=T,Y=Y)
network_lorenz.save_weights('./NN_lorenz_checkpoints_001/my_checkpoint', save_format="tf")
T, Y = create_data_nonlinear(p=0.01)
train_nonlinear(network_nonlinear, 8000,T=T,Y=Y)
network_nonlinear.save_weights('./NN_nonlinear_checkpoints_001/my_checkpoint', save_format="tf")
T, Y = create_data_twocompart(p=0.01)
train_twocompart(network_twocompart, 4000,T=T,Y=Y)
network_twocompart.save_weights('./NN_twocompart_checkpoints_001/my_checkpoint', save_format="tf")
print("$"*25)
