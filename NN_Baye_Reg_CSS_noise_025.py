...
network_lorenz.load_weights('./NN_lorenz_checkpoints_025/my_checkpoint', save_format="tf")
T, Y = create_data_nonlinear(p=0.25)
network_nonlinear.load_weights('./NN_nonlinear_checkpoints_025/my_checkpoint', save_format="tf")
T, Y = create_data_twocompart(p=0.25)
network_twocompart.load_weights('./NN_twocompart_checkpoints_025/my_checkpoint', save_format="tf")
print("$"*25)
...
np.save('nn_BR_CSS_025_tc_1',start_1['beta_1'])
np.save('nn_BR_CSS_025_tc_2',start_2['beta_1'])
...
np.save('nn_BR_CSS_025_nl_1',start_1['beta_1'])
np.save('nn_BR_CSS_025_nl_2',start_2['beta_1'])
...
np.save('nn_BR_CSS_025_lr_1',start_1['beta_1'])
np.save('nn_BR_CSS_025_lr_2',start_2['beta_1'])
np.save('nn_BR_CSS_025_lr_1',start_3['beta_1'])
